...
int main(int argc, char* argv[]) {
  ...
  if (argc != 3) {
    ...
    //std::string vtkFileName = outputFileName.substr(0, outputFileName.length() - 4) + ".vtk";
    //writeVTKTriFile(vtkFileName, uniqueVertexList, triangleVerticesList);
    //writeVTKQuadFile(vtkFileName, uniqueVertexList, connectionsList);
